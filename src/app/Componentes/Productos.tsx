...
import ne from "../imagenes/marcas/new-era-logo.png"
import cuatrosiete from "../imagenes/marcas/'47_logo.svg.png"
import vans from "../imagenes/marcas/vanss.png"
import nike from "../imagenes/marcas/Nike-logo.png"
import adidas from "../imagenes/marcas/Original_Adidas_logo.svg.png"
import puma from "../imagenes/marcas/PUMA-logo.png"
    ...
    <div className="container text-center">
        ...
        <div className="row pt-3 ">
            <div className="col col-md-4">
                ...
                <img src={ne.src} alt="New Era" title="New Era" width="215px" height="150px"/>
                </a>
                <p className="mediano-p my-3">New Era</p>
            </div>
            <div className="col col-md-4">
                <a href="https://www.47brand.com/" target="_blank">
                    <img src={cuatrosiete.src} alt="'47" title="'47 Brand" width="158px" height="158px"/>
                </a>
            ...
            <div className="col col-md-4">
                <a href="https://www.vans.cl/?gclid=CjwKCAjwo7iiBhAEEiwAsIxQEcfiaaEHH2gOxfbk2iXzHModuM-LpwubfdvpTMRHCrID6x6FSaLfbxoCuAwQAvD_BwE" target="_blank" >
                    <img src={vans.src} alt="Vans" title="Vans" width="215px" height="150px"/>
                </a>
                <p className="mediano-p my-3">Vans</p>
            </div>
            <div className="col col-md-4">
                <a href="https://www.nike.cl/" target="_blank">
                <img src={nike.src} alt="Nike" title="Nike" width="215px" height="180px"/>
                </a>
                <p className="mediano-p my-3">Nike</p>
            </div>
            <div className="col col-md-4">
                <a href="https://www.adidas.cl/" target="_blank">
                <img src={adidas.src} alt="Adidas" title="Adidas" width="200px" height="200px"/>
                </a>
            ...
            <div className="col col-md-4">
                ...
                <img src={puma.src} alt="Puma" title="Puma" width="215px" height="200px"/>
                </a>
